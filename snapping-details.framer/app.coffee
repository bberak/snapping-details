...
wine = new Layer
	parent: bg
	html: "<h2>2007 Cabernet Sauvignon</h2>"
	style: 
		padding: "30px 0px 0px 20px"
		color: "#877DD7"
	width: 650
...
description = new Layer
	parent: bg
	html: "The wine has a complex fragrant dark fruit nose of ripe blackcurrants, blackberries and black plums, with hints of spice, which is replicated on the concentrated palate. Fine-grained grape tannins balance the rich flavours and seamlessly integrated elegant French oak tannins, giving the wine a smooth long finish"
	style: 
